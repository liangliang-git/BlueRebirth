...
> 生成时间 `2026-09-06T21:49:20.5665654+00:00`。所有数据库均以只读方式访问，原始客户端文件未修改。

> 说明：本次部署目录只提供日服 `catalog/config`，因此 `jp-1.4.0` 与 `cn-1.5.20` 两个扫描槽均指向同一目录。该报告证明部署配置可完整解码，不作为独立日服/国服差异结论；独立国服目录接入后可用同一命令重跑差异表。
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `jp-1.4.0` | 497 | 316663 | 497 | 316166 | 0 |
| `cn-1.5.20` | 497 | 316663 | 497 | 316166 | 0 |
...
| ---: | ---: | ---: | --- | ---: | --- |
| 1 | 7107 | 336 | `item` | 100.0% | `` |
| 2 | 369 | 129 | `equipment` | 100.0% | `` |
| 3 | 169 | 70 | `ship` | 100.0% | `` |
| 5 | 3783 | 19 | `currency` | 100.0% | `` |
| 6 | 302 | 4 | `unresolved` | 0.0% | `60000, 60002, 60001, 60003` |
| 8 | 1159 | 175 | `unresolved` | 0.0% | `80357, 80362, 80363, 80044, 80361, 80358, 80154, 80371, 80416, 80222, 80259, 80170, 80118, 80155, 80528, 80171, 80417, 80040, 81007, 80360` |
| 11 | 539 | 21 | `unresolved` | 0.0% | `110097, 110003, 110056, 110055, 110043, 110096, 110100, 110108, 110099, 110002, 110105, 110104, 110106, 110048, 110102, 110101, 110046, 110047, 110107, 110095` |
| 12 | 36 | 4 | `unresolved` | 0.0% | `120004, 120005, 120006, 120007` |
| 14 | 3 | 2 | `unresolved` | 0.0% | `140002, 140001` |
| 15 | 733 | 6 | `unresolved` | 0.0% | `150001, 150004, 150003, 150005, 150006, 150002` |
| 16 | 85 | 82 | `unresolved` | 0.0% | `168226, 168301, 168227, 168205, 168280, 168109, 168260, 168264, 168265, 168266, 168270, 168271, 168272, 168256, 168278, 168253, 168249, 168273, 168288, 168204` |
| 18 | 37 | 37 | `fashion` | 100.0% | `` |
| 22 | 4 | 4 | `unresolved` | 0.0% | `220228, 220227, 220226, 220225` |
| 24 | 50 | 48 | `player_head_frame` | 100.0% | `` |
| 25 | 55 | 51 | `interaction_item` | 100.0% | `` |
...
| 28 | 245 | 5 | `unresolved` | 0.0% | `280002, 280004, 280005, 280001, 280008` |
